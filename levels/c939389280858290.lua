...
--
function get_name()
    return "TACAN TRN-26: A1 Level Detector"
end
...
function get_description()
    return { 
        ...
        "Reference A1 Book Pg 8",
        "The A1 level detector card is the first card within the signal processing path, it detects inputs in the form of video pulses coming from the receiver, any input that is above the threshold level gets through the card and can be seen on its output, These pulses could be TACAN pulse a pairs from aircraft or squitter generated by the log IF amp. The threshold level is 80, 50 is the mean level and 0 is the minimum level. The output is always inverted.",
        "Good Luck"
...
--
function get_data()
    RxInput = {55,100,51,62,53,54,80,75,85,74,55,90,52,99,54,64,70,52,90,58,68,69,70,54,54,75,50,53,65,90,62,88,62,77,60,60,50,90,61,90,50,90,55,85,58,90
                ,50,80,50,70,70,75,72,40,85,68,88,99,50,70}
    A2Output = {50,000,50,50,50,50,0,50,0,50,50,0,50,0,50,50,50,50,0,50,50,50,50,50,50,50,50,50,50,0,50,0,50,50,50,50,50,0,50,0,50,0,50,0,50,0
                ,50,0,50,50,50,50,50,50,0,50,0,0,50,50}




    create_terminal("Input from the Rx'r", "0", TYPE_SIMPLE, DIR_INPUT, RxInput)
    create_terminal("Output to A2 ", "1", TYPE_SIMPLE, DIR_OUTPUT, A2Output)
end
