...
--
function get_name()
    return "TACAN TRN-26: A2 Decoder"
end
...
function get_description()
    return { 
        ...
        "Reference A2 Book Pg 8",
        "The A2 Decoder will filter out TACAN pulse pairs from noise. Any two pulses that are within 9.5 and 14 microseconds within one another from leading edge to leading edge will generate a negative going pulse. In the case of this game two pulses must be within 2 time squares of one another to generate a negative going pulse.",
        "Good Luck"
    }
end
...
--
function get_data()
    A1Input = {50,000,50,50,50,50,0,50,0,50,50,0,50,0,50,50,50,50,0,50,50,50,50,50,50,50,50,50,50,0,50,0,50,50,50,50,50,0,50,0,50,0,50,0,50,0
                ,50,0,50,50,50,50,50,50,0,50,0,0,50,50}
    A3Output = {50,50,50,50,50,50,50,50,0,50,50,50,50,0,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,50,0,50,50,50,50,50,50,50,0,50,50,50,0,50,50
                ,50,0,50,50,50,50,50,50,50,50,0,50,50,50}  




    create_terminal("Input from A1", "0", TYPE_SIMPLE, DIR_INPUT, A1Input)
    create_terminal("Output to A3", "1", TYPE_SIMPLE, DIR_OUTPUT, A3Output)
end
